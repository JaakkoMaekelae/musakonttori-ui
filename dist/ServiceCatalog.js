...
export const SERVICES = [
    ...
    },
    {
        ...
        url: (locale) => `https://musakonttori-sopimushallinta.vercel.app/${locale}/julkaisu`,
        available: true,
    },
    {
        key: "mastering",
...
export function ServiceCatalog({ locale = "fi", hideFooterCta = false }) {
    ...
    return (_jsx("section", { className: "sect", id: "kaikki-palvelut", children: _jsxs("div", { className: "container", children: [_jsxs("div", { className: "sect-header", children: [_jsx("span", { className: "eyebrow", children: isFi ? "Musakonttori-ekosysteemi" : "Musakonttori ecosystem" }), _jsx("h2", { children: isFi ? "Kaikki palvelut" : "All services" }), _jsxs("p", { className: "sect-lead max-w-2xl mx-auto", children: [isFi
                                    ...
                                    : "Each service has its own pricing model. Choose the services you need — the more you use, the better the overall price.", _jsx("br", {}), _jsx("span", { className: "text-sm text-gray-400 mt-1 block", children: isFi
                                        ? "StageFlow ja Market ovat tulossa. Kysy tarjous: hello@musakonttori.fi"
                                        : "StageFlow and Market coming soon. Request a quote: hello@musakonttori.fi" })] })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: SERVICES.map((svc) => {
