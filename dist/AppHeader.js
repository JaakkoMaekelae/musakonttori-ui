...
function headerLabelsFor(locale, override) {
    const base = APP_HEADER_LABELS[locale ?? "fi"] ?? APP_HEADER_LABELS.fi;
    return override ? { ...base, ...override } : base;
}
export function AppHeader({ productName, productHref = "/", navItems, user, onSignOut, signInHref = "/auth/sign-in", className, locale, labels, }) {
