 ...
 */
export declare function Workspace({ rail, nav, list, detail, ids, selectedId, onSelect, onClear, expanded, onNeedMore, hasMore, listLabel, detailLabel, navCollapsed, className, }: WorkspaceProps): import("react").JSX.Element;
