 ...
 */
export const AdminShell = forwardRef(function AdminShell({ rail, nav, list, detail, detailState = "closed", onCloseDetail, onSelectPrevious, onSelectNext, navCollapsed = false, className, listLabel = "List", detailLabel = "Details", }, ref) {
    ...
    return (_jsxs("div", { ref: (node) => {
            ...
            if (typeof ref === "function")
                ...
                ref.current = node;
        }, className: cn("mk-shell", className), "data-mk-shell": "", "data-detail": detailState, "data-nav-collapsed": navCollapsed ? "" : undefined, onKeyDown: handleKeyDown, children: [_jsx("div", { className: "mk-shell-rail", "data-mk-zone": "rail", children: rail }), _jsx("div", { className: "mk-shell-nav", "data-mk-zone": "nav", hidden: navCollapsed, children: nav }), _jsx("main", { className: "mk-shell-list", "data-mk-zone": "list", "aria-label": listLabel, children: list }), detailState !== "closed" && (_jsx("aside", { className: "mk-shell-detail", "data-mk-zone": "detail", "aria-label": detailLabel, children: detail }))] }));
});
const SHELL_CSS = `
.mk-shell {
  display: grid;
