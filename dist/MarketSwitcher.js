...
import { MARKETS, MARKET_CURRENCIES } from "./markets";
 ...
 */
export function MarketSwitcher({ country = "FI", currency = "EUR", onCountryChange, onCurrencyChange, size = "md", className, }) {
