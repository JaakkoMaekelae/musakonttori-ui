...
export function SignInLayout({ productName, productTagline, brandEyebrow, brandTitle, brandTitleAccent, brandDescription, benefits, previewTitle, previewValue, previewStatus, previewOrderName, previewOrderId, previewOrderStatus, previewOrderAmount, formTitle, formSubtitle, formDescription, onSignIn, accountsUrl, accountsFrom, registerHref, registerLabel, registerTitle, registerDescription, backHref, backLabel, securityNote, errorMessage, className, }) {
    ...
    return (_jsx("div", { className: cn("min-h-svh p-[clamp(12px,2vw,28px)] max-sm:p-0", className), style: {
            background: `linear-gradient(135deg, color-mix(in srgb, ${primary} 5%, transparent), transparent 45%), var(--mk-palette-bg-canvas, var(--mk-palette-bg, #0D0F17))`,
        }, children: _jsxs("div", { className: "mx-auto grid w-full min-h-[calc(100svh-clamp(24px,4vw,56px))] max-w-[1440px] overflow-hidden rounded-[28px] border shadow-2xl max-sm:min-h-svh max-sm:rounded-none max-sm:border-0", style: {
              ...
              `,
                                ...
                                background: "rgba(12,12,14,0.72)",
                                        ...
                                        }, children: [_jsx("svg", { width: "17", height: "17", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true", children: _jsx("path", { d: "M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4M10 17l5-5-5-5M13.8 12H3" }) }), "Kirjaudu Musakonttori-tunnuksella"] }), _jsxs("div", { className: "flex items-center gap-3 my-5", children: [_jsx("div", { className: "flex-1 h-px", style: { background: "var(--mk-palette-border-subtle, rgba(255,255,255,0.08))" } }), _jsx("span", { className: "text-xs", style: { color: "var(--mk-palette-text-tertiary, #7E8292)" }, children: "tai" }), _jsx("div", { className: "flex-1 h-px", style: { background: "var(--mk-palette-border-subtle, rgba(255,255,255,0.08))" } })] })] })) : null, _jsxs("form", { onSubmit: handleSubmit, className: "mt-9 grid gap-[21px]", children: [hasError && (_jsxs("div", { className: "flex items-start gap-[10px] rounded-[10px] border p-[13px_14px] text-xs leading-[1.55]", role: "alert", style: {
                                            borderColor: `color-mix(in srgb, ${errorColor} 24%, transparent)`,
                                            background: errorSubtle,
                                            color: errorColor,
                                        }, children: [_jsx("span", { className: "grid h-[18px] w-[18px] flex-none place-items-center rounded-full text-[10px] font-black text-white", style: { background: errorColor }, children: "!" }), _jsx("p", { className: "m-0", children: errorMessage })] })), _jsxs("div", { className: "grid gap-[9px]", children: [_jsx("label", { className: "text-xs font-extrabold", htmlFor: "signin-email", style: { color: "var(--mk-palette-text-primary, #F0F0F3)" }, children: "S\u00E4hk\u00F6posti" }), _jsxs("div", { className: "relative flex items-center", children: [_jsx("span", { className: "pointer-events-none absolute left-4", style: { color: "var(--mk-palette-text-tertiary, #7E8292)" }, children: _jsx(MailIcon, {}) }), _jsx("input", { id: "signin-email", name: "email", type: "email", autoComplete: "email", required: true, value: email, onChange: (e) => setEmail(e.target.value), placeholder: "sin\u00E4@esimerkki.fi", "aria-invalid": hasError ? "true" : undefined, className: "h-[54px] w-full rounded-xl border bg-transparent px-12 text-sm outline-none transition-colors duration-[160ms] ease-in-out", style: {
                                                        ...
                                                        } })] })] }), _jsxs("div", { className: "grid gap-[9px]", children: [_jsx("label", { className: "text-xs font-extrabold", htmlFor: "signin-password", style: { color: "var(--mk-palette-text-primary, #F0F0F3)" }, children: "Salasana" }), _jsxs("div", { className: "relative flex items-center", children: [_jsx("span", { className: "pointer-events-none absolute left-4", style: { color: "var(--mk-palette-text-tertiary, #7E8292)" }, children: _jsx(LockIcon, {}) }), _jsx("input", { id: "signin-password", name: "password", type: showPassword ? "text" : "password", autoComplete: "current-password", required: true, value: password, onChange: (e) => setPassword(e.target.value), placeholder: "\u2022\u2022\u2022\u2022\u2022\u2022\u2022\u2022", "aria-invalid": hasError ? "true" : undefined, className: "h-[54px] w-full rounded-xl border bg-transparent px-12 text-sm outline-none transition-colors duration-[160ms] ease-in-out", style: {
                                                            ...
                                                            e.currentTarget.style.boxShadow = "none";
                                                            e.currentTarget.style.background = "var(--mk-palette-bg-canvas, var(--mk-palette-bg, #0D0F17))";
                                                        } }), _jsx("button", { type: "button", onClick: () => setShowPassword((v) => !v), className: "absolute right-2 grid h-10 w-10 place-items-center rounded-lg border-0 bg-transparent cursor-pointer", style: { color: "var(--mk-palette-text-secondary, #B0B3C1)" }, "aria-label": showPassword ? "Piilota salasana" : "Näytä salasana", onMouseEnter: (e) => {
