...
export function OfflineIndicator({
  ...
  return (
    <div
      role="alert"
      className={cn(
        "fixed bottom-20 left-1/2 z-50 -translate-x-1/2 flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium shadow-lg",
        "bg-[var(--mk-palette-bg-warning,#F59E0B)] text-[var(--mk-palette-text-on-warning,#000000)]",
        className,
      )}
    >
