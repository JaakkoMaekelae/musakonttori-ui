...
export const EU_VAT_RATES: Record<string, VatRates> = {
...
export function getVATRate(countryCode: string, productType?: string): number {
  return getProductVATRate(countryCode, (productType as ProductType) ?? "general");
}

export function determineVATScheme(
  sellerCountry: string,
  buyerCountry: string,
...
export function calculateVAT(
  ...
  const vatRate = getProductVATRate(buyerCountry, (productType as ProductType) ?? "general");
