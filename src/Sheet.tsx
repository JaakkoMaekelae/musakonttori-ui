  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-[var(--mk-palette-bg,#FFFFFF)] bg-clip-padding text-sm text-[var(--mk-palette-text-primary,#111113)] shadow-lg transition duration-200 ease-in-out",
...
function SheetTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-base font-medium text-[var(--mk-palette-text-primary,#111113)]",
        className,
      )}
      {...props}
    />
...
function SheetDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-sm text-[var(--mk-palette-text-secondary,#5F6068)]", className)}
      {...props}
    />
  );
}
