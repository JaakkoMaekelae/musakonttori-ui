  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className={cn(
          "mx-auto w-full max-w-lg rounded-2xl border border-[var(--mk-palette-border-default,rgba(255,255,255,0.12))] bg-[var(--mk-palette-bg-surface,#1E2130)] shadow-xl",
          "animate-in fade-in-0 zoom-in-95 slide-in-from-top-4 duration-200",
          className,
        )}
      >
        {title && (
          <div className="flex items-center justify-between border-b border-[var(--mk-palette-border-subtle,rgba(255,255,255,0.06))] px-6 py-4">
            <h3 id="modal-title" className="text-lg font-semibold text-[var(--mk-palette-text-primary,#F0F0F3)]">
              {title}
            </h3>
            <button
              data-modal-close
        ...
        {footer && (
          <div className="rounded-b-2xl border-t border-[var(--mk-palette-border-subtle,rgba(255,255,255,0.06))] bg-[var(--mk-palette-bg,#0D0F17)]/50 px-6 py-4">
            {footer}
          </div>
        )}
      </div>
